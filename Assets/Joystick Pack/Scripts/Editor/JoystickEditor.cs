...
public class JoystickEditor : Editor
{
    ...
    private SerializedProperty mainJoystick, borderJoystick;
    ...
    protected virtual void OnEnable()
    {
        ...
        mainJoystick = serializedObject.FindProperty("mainJoystick");
        borderJoystick = serializedObject.FindProperty("borderJoystick");
    }
    ...
    protected virtual void DrawValues()
    {
        ...
        EditorGUILayout.PropertyField(mainJoystick, new GUIContent("Main joystick image", ""));
        EditorGUILayout.PropertyField(borderJoystick, new GUIContent("Border joystick image", ""));
    }
